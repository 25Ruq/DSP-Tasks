...
def generate_verify():
    ...
    wavetype = var.get()
    if wavetype == "sin":
        SignalSamplesAreEqual(r'C:\Users\hb\PycharmProjects\DSP-Tasks\Task1\Signals\Sin_Cos\SinOutput.txt',
                              int(sfreqText.get("1.0", "end-1c")), wave)
    elif wavetype == "cos":
        SignalSamplesAreEqual(r'C:\Users\hb\PycharmProjects\DSP-Tasks\Task1\Signals\Sin_Cos\CosOutput.txt',
                              int(sfreqText.get("1.0", "end-1c")), wave)
def generateWave():
